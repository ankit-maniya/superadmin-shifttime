...
export default function ContactUs() {
    ...
    const submitContactUsForm = async (formData) => {
        try {
            ...
            toast.error("Failed to submit contact us form. Please try again.")
        }
    }
    ...
    return (
        <AdminWrapper>
            ...
            <div class="max-w-screen-lg mx-auto p-5">
                <div class="grid grid-cols-1 md:grid-cols-12 rounded-md border border-green-550 shadow-lg hover:shadow-green-200">
                    <div class="bg-gray-900 md:col-span-4 p-10 text-white">
                        <h3 class="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
                            Get In <span class="text-green-550">Touch</span>
                        </h3>
                        <p class="mt-4 leading-7 text-gray-200">
                            ShiftTime is a cutting-edge scheduling and workforce management platform designed to streamline employee scheduling, optimize shift planning, and enhance operational efficiency for businesses of all sizes.
                        </p>

                        <div class="flex items-center mt-5">
                            <svg class="h-6 mr-2 text-green-550" fill="currentColor" version="1.1"
                            ...
                            <span class="text-sm">308 King Street, North Waterloo, ON, Canada.</span>
                        </div>
                        <div class="flex items-center mt-5">
                            <svg class="h-6 mr-2 text-green-550" fill="currentColor" version="1.1" id="Capa_1"
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                            ...
                            <span class="text-sm">+1 226-883-2602</span>
                        </div>
                        <div class="flex items-center mt-5">
                            <svg class="h-6 mr-2 text-green-550" fill="currentColor" version="1.1" id="Capa_1"
                                xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                s135.494,60.782,135.494,135.493S225.205,285.987,150.494,285.987z">
                    ...
                    <ContactUSForm submitContactUsForm={(data) => submitContactUsForm(data)} />
